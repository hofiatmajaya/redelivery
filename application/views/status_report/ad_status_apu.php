    ...
    <div class="box-body">
      ...
      <div class="row">
        <div class="col-md-6 col-xs-12 col-offset-12 pull-right">
          <div class="form-group">
            <div class="col-md-6">
              <label>TSN : </label><input type="text" placeholder="NO DATA" class="form-control" />
            </div>
            <div class="col-md-6">
              <label>CSN : </label><input type="text" placeholder="NO DATA" class="form-control" />
            </div>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12" style="overflow-x:auto;">
          <table class="table table-hover table-bordered table-gmf" id="tabel_detail">
            <thead>
              <tr>
                <th class="text-center">Original Auth. AD</th>
                <th class="text-center">Effect Date</th>
                <th class="text-center">Subject</th>
                <th class="text-center">Reference</th>
                <th class="text-center">Method of Comp.</th>
                <th class="text-center">Date of Comp.</th>
                <th class="text-center">Repetitive Interval</th>
