          ...
          <table class="table table-hover table-bordered table-gmf" id="tabel_detail">
            <thead>
              <tr>
                ...
                <th class="text-center">STC No</th>
                <th class="text-center">STC Holder</th>
                <th class="text-center">Subject</th>
                <th class="text-center">Method of Compliance</th>
                <th class="text-center">Date of Compliance</th>
                <th class="text-center">Date of Compliance</th>
                <th class="text-center">Accomplish FC</th>
